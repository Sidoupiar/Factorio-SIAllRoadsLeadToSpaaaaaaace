...
-- 当没有加载 Core 功能模块时 , 下列功能均失效 , 只会返回一个基础的窗口<br>
-- ======================================================================<br>
...
-- ======================================================================<br>
---@param player table -- 要创建的窗口的玩家
---@param settingsElement table -- 玩家持久化数据的对应部分表 , 用于同步窗口的位置信息 , 会占用 [ settingsElement.frame ] 和 [ settingsElement.frameLocation ] 属性
---@param frameData table -- 窗口数据
---@return table -- 创建的窗口
...
-- ======================================================================<br>
---@param frame table -- 窗口
---@return table -- 用于持久化的窗口实际位置
...
-- ======================================================================<br>
---@param currentIndex string -- 事件触发的控件名称
---@param radioList table -- 单选按钮列表
...
-- ======================================================================<br>
---@param radioList table -- 单选按钮列表
---@return string|nil -- 第一个被选中的单选按钮的索引
...
-- 此函数会自动纠正输入的字符<br>
-- ======================================================================<br>
---@param textfield table -- 文本条控件
---@return integer -- 文本条中输入的数字 , 默认 0
