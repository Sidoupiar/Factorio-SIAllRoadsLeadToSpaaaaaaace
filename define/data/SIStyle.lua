...
function SIStyle.ColorButton( location , dirt )
	return
	{
		...
		default_font_color = SICommon.Colors.FontColor.BLACK ,
		hovered_font_color = SICommon.Colors.FontColor.BLACK ,
		clicked_font_color = SICommon.Colors.FontColor.BLACK ,
		disabled_font_color = { 0.7 , 0.7 , 0.7 } ,
		selected_font_color = SICommon.Colors.FontColor.BLACK ,
		selected_hovered_font_color = SICommon.Colors.FontColor.BLACK ,
		selected_clicked_font_color = SICommon.Colors.FontColor.BLACK ,
