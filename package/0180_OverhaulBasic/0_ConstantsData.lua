local constantsData =
{
	...
	BeforeLoad = function( constantsData )
		...
		if SIConfigs.SIOverhaulBasic.EnemyCorpseDuration    ~= nil then constantsData.Settings.EnemyCorpseDuration    = { Type = SICommon.SettingTypes.INT  , Affect = SICommon.SettingAffectTypes.StartUp , Default = SIConfigs.SIOverhaulBasic.EnemyCorpseDuration    , Min = SICommon.Numbers.MultiplierMin , Max = SICommon.Numbers.MultiplierMax } end
