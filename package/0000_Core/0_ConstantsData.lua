local constantsData =
{
	...
	-- ======================================================================<br>
	-- 每个阶段载入所有 lua 文件之前调用这个函数<br>
	-- 如果没有定义此函数则不会调用<br>
	-- 参数为当前正在加载的 ConstantsData 和当前阶段的 SIInit.State<br>
	-- ======================================================================<br>
	-- BeforeStateLoadFile = function( constantsData , currentState ) end ,

	-- ======================================================================<br>
	-- 每个阶段载入所有 lua 文件之后调用这个函数<br>
	-- 如果没有定义此函数则不会调用<br>
	-- 参数为当前正在加载的 ConstantsData 和当前阶段的 SIInit.State<br>
	-- ======================================================================<br>
	-- AfterStateLoadFile = function( constantsData , currentState ) end ,
