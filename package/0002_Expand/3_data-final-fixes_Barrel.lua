...
.ForEach( SICommon.Types.Fluid , function( fluidPrototypeName , fluidPrototypeData )
	if SIConfigs.SIExpand.BarrelBlackList[fluidPrototypeName] then
		return
	end
	if fluidPrototypeData and not fluidPrototypeData.hidden and ( SIConfigs.SIExpand.IgnoreAutoBarrel or fluidPrototypeData.auto_barrel ~= false ) then
			...
			.Append
			{
				...
				ingredients =
				{
					...
					} ,
					{
						...
						name = fluidName ,
						amount = SIConfigs.SIExpand.BarrelSize
					}
				} ,
				results =
				{
			...
			.Append
			{
				...
				results =
				{
					...
					} ,
					{
						...
						name = fluidName ,
						amount = SIConfigs.SIExpand.BarrelSize ,
						catalyst_amount = SIConfigs.SIExpand.BarrelSize
					}
				} ,
