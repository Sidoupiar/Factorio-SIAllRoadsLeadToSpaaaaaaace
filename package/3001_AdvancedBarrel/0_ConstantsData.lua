local constantsData =
{
	...
	BeforeLoad = function( constantsData )
		...
		if SIConfigs.SIAdvancedBarrel.BarrelRocketSize ~= nil then constantsData.Autoload.Settings.BarrelRocketSize = { Type = SICommon.SettingTypes.INT  , Affect = SICommon.SettingAffectTypes.StartUp , Default = SIConfigs.SIAdvancedBarrel.BarrelRocketSize , Min = SICommon.Numbers.RocketSizeMin , Max = SICommon.Numbers.RocketSizeMax } end
	end
}
